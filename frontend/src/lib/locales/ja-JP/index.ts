...
export const jaJP = {
  ...
  sources: {
    ...
    grouping: {
      ...
      ungrouped: "フォルダー未設定",
      newGroup: "新規フォルダー",
      newSubgroup: "新規サブフォルダー",
      newGroupTitle: "新規フォルダー",
      renameGroupTitle: "フォルダーの名前を変更",
      groupNamePlaceholder: "フォルダー名",
      groupOptions: "Options for {{name}}",
      moveTo: "Move to...",
      moveHere: "Move here",
      moveGroupTitle: "Move \"{{name}}\"",
      rootOption: "Root",
      noGroups: "フォルダーはまだありません",
      deleteGroupTitle: "フォルダー「{{name}}」を削除しますか？",
      deleteGroupDesc: "フォルダー内のソースはフォルダーから外れます。",
      deleteGroupWithSources: "このフォルダー内のすべてのソースも削除",
      deleteGroupWithSourcesWarn: "このフォルダーとサブフォルダー内のすべてのソースは完全に削除され、元に戻せません。",
      cascadeConfirmTitle: "Delete sources permanently?",
      cascadeConfirmDesc: "このフォルダーとサブフォルダー内のソースは、ファイルやインサイトとともに削除されます。この操作は取り消せません。",
      ...
      moveToGroup: "フォルダーへ移動",
      copyToGroup: "フォルダーへコピー",
      ungroupAction: "フォルダーから外す",
      moveToGroupTitle: "ソースをフォルダーへ移動",
      copyToGroupTitle: "ソースをフォルダーへコピー",
      copyHere: "Copy here",
      moveSuccess: "Moved {{count}} source(s)",
      copySuccess: "Copied {{count}} source(s)",
      ungroupSuccess: "{{count}} 件のソースをフォルダーから外しました",
      bulkPartial: "{{success}} succeeded, {{failed}} failed",
      operationFailed: "The operation failed. Please try again.",
      rowActions: "「{{title}}」の操作",
      renameSource: "名前を変更",
      renameSourceTitle: "ソースの名前を変更",
      copyTo: "コピー先…",
      copyCreatedToast: "「{{title}}」のコピーを作成しました",
      batchRename: "名前を変更",
      batchRenameTitle: "一括リネーム",
      batchRenameDesc: "選択した {{count}} 件のソースにリネーム規則を適用します",
      prefixLabel: "先頭に追加",
      suffixLabel: "末尾に追加",
      findLabel: "検索",
      replaceLabel: "置換後の文字列",
      previewLabel: "プレビュー：{{count}} 件中 {{changed}} 件が変更されます",
      previewUnchanged: "変更なし",
      noChanges: "現在の規則ではどのソースも変更されません",
      applyRename: "リネームを適用",
      renameSuccess: "{{count}} 件のソースの名前を変更しました",
      renameSlowHint: "件数が多い場合は 1 件ずつ書き込むため時間がかかります",
      batchDelete: "削除",
      batchDeleteConfirmTitle: "{{count}} 件のソースを削除しますか？",
      batchDeleteConfirmDesc: "ソースはファイル・インサイト・フォルダー割り当てとともに削除され、元に戻せません。",
      batchDeleteSuccess: "{{count}} 件のソースを削除しました",
      dragInvalidTarget: "自身やそのサブフォルダーへは移動できません",
      saveToFolder: "フォルダーに保存（任意）",
      noFolderOption: "フォルダーに入れない",
      targetFolderLabel: "保存先フォルダー",
      selectFolder: "フォルダーを選択",
      stepNotebooksAndFoldersTitle: "ノートブックとフォルダー",
      stepNotebooksAndFoldersDesc: "ノートブックに関連付け、フォルダーに整理",
      aiOverwriteHint: "AI の再分類を実行すると、このビューの手動整理が上書きされます",
      folderAssignFailed: "{{count}} 件のソースを作成しましたが、フォルダーに入れられませんでした",
      breadcrumbAria: "現在の場所",
      ...
      classify: {
        ...
        confirmDescription: "AI が「{{name}}」のすべてのフォルダーを再構築します。このビューの既存フォルダーと手動での整理は上書きされます。",
        ...
        doneSummary: "完了：{{groups}} 個のフォルダーを作成、{{sources}} 件のソースを分類、{{unclassified}} 件は未分類",
  ...
  settings: {
    ...
    appearance: "外観",
    appearanceDesc: "Open Notebook の見た目を選択します。即時反映されます。",
    skin: "インターフェーススキン",
    skinQuietGreen: "Quiet Green",
    skinQuietGreenDesc: "デフォルトの外観——温かみのある紙の色調とグリーンのアクセント。",
    skinClassic: "クラシック",
    skinClassicDesc: "旧バージョンの白とブルーのインターフェース。",
  },
  advanced: {
    title: "詳細ツール",
