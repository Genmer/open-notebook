...
export const bnIN = {
  ...
  sources: {
    ...
    grouping: {
      ...
      all: "All",
      ungrouped: "ফোল্ডারে নেই",
      newGroup: "নতুন ফোল্ডার",
      newSubgroup: "নতুন সাবফোল্ডার",
      newGroupTitle: "নতুন ফোল্ডার",
      renameGroupTitle: "ফোল্ডারের নাম বদলান",
      groupNamePlaceholder: "ফোল্ডারের নাম",
      groupOptions: "Options for {{name}}",
      moveTo: "Move to...",
      moveHere: "Move here",
      moveGroupTitle: "Move \"{{name}}\"",
      rootOption: "Root",
      noGroups: "এখনও কোনো ফোল্ডার নেই",
      deleteGroupTitle: "\"{{name}}\" ফোল্ডারটি মুছবেন?",
      deleteGroupDesc: "ভেতরের সোর্সগুলো ফোল্ডার থেকে সরানো হবে।",
      deleteGroupWithSources: "এই ফোল্ডারের সব সোর্সও মুছুন",
      deleteGroupWithSourcesWarn: "এই ফোল্ডার ও এর সাবফোল্ডারের সব সোর্স স্থায়ীভাবে মুছে যাবে। এটি ফেরানো যাবে না।",
      cascadeConfirmTitle: "Delete sources permanently?",
      cascadeConfirmDesc: "এই ফোল্ডার ও এর সাবফোল্ডারের সোর্সগুলো তাদের ফাইল ও ইনসাইটসহ মুছে যাবে। এটি ফেরানো যাবে না।",
      ...
      moveToGroup: "ফোল্ডারে সরান",
      copyToGroup: "ফোল্ডারে কপি করুন",
      ungroupAction: "ফোল্ডার থেকে সরান",
      moveToGroupTitle: "সোর্সগুলো ফোল্ডারে সরান",
      copyToGroupTitle: "সোর্সগুলো ফোল্ডারে কপি করুন",
      copyHere: "Copy here",
      moveSuccess: "Moved {{count}} source(s)",
      copySuccess: "Copied {{count}} source(s)",
      ungroupSuccess: "{{count}}টি সোর্স ফোল্ডার থেকে সরানো হয়েছে",
      bulkPartial: "{{success}} succeeded, {{failed}} failed",
      operationFailed: "The operation failed. Please try again.",
      rowActions: "{{title}}-এর অপশন",
      renameSource: "নাম বদলান",
      renameSourceTitle: "সোর্সের নাম বদলান",
      copyTo: "এখানে কপি করুন...",
      copyCreatedToast: "\"{{title}}\"-এর একটি কপি তৈরি হয়েছে",
      batchRename: "নাম বদলান",
      batchRenameTitle: "একসাথে নাম বদলানো",
      batchRenameDesc: "নির্বাচিত {{count}}টি সোর্সের জন্য নাম বদলানোর নিয়ম দিন",
      prefixLabel: "প্রিফিক্স",
      suffixLabel: "সাফিক্স",
      findLabel: "খুঁজুন",
      replaceLabel: "প্রতিস্থাপন করুন",
      previewLabel: "প্রিভিউ: {{count}}টির মধ্যে {{changed}}টি বদলাবে",
      previewUnchanged: "অপরিবর্তিত",
      noChanges: "এই নিয়মে কোনো সোর্স বদলাবে না",
      applyRename: "নাম বদলানো প্রয়োগ করুন",
      renameSuccess: "{{count}}টি সোর্সের নাম বদলানো হয়েছে",
      renameSlowHint: "আইটেমগুলো একটি একটি করে প্রয়োগ হয়; কিছু সময় লাগতে পারে",
      batchDelete: "মুছুন",
      batchDeleteConfirmTitle: "{{count}}টি সোর্স মুছবেন?",
      batchDeleteConfirmDesc: "সোর্সগুলো তাদের ফাইল, ইনসাইট ও ফোল্ডার নির্ধারণসহ মুছে যাবে। এটি ফেরানো যাবে না।",
      batchDeleteSuccess: "{{count}}টি সোর্স মুছে ফেলা হয়েছে",
      dragInvalidTarget: "নিজের বা নিজের সাবফোল্ডারে সরানো যায় না",
      saveToFolder: "ফোল্ডারে সংরক্ষণ করুন (ঐচ্ছিক)",
      noFolderOption: "কোনো ফোল্ডারে রাখবেন না",
      targetFolderLabel: "টার্গেট ফোল্ডার",
      selectFolder: "ফোল্ডার নির্বাচন করুন",
      stepNotebooksAndFoldersTitle: "নোটবুক এবং ফোল্ডার",
      stepNotebooksAndFoldersDesc: "নোটবুকের সাথে সংযুক্ত করুন এবং একটি ফোল্ডারে সংগঠিত করুন",
      aiOverwriteHint: "AI পুনঃশ্রেণীবিভাগ চালালে এই ভিউয়ের ম্যানুয়াল সাজানো মুছে যাবে",
      folderAssignFailed: "{{count}}টি সোর্স তৈরি হয়েছে কিন্তু ফোল্ডারে রাখা যায়নি",
      breadcrumbAria: "বর্তমান অবস্থান",
      ...
      classify: {
        ...
        confirmDescription: "AI \"{{name}}\"-এর সব ফোল্ডার নতুন করে তৈরি করবে। এই ভিউয়ের বিদ্যমান ফোল্ডার ও ম্যানুয়াল সাজানো প্রতিস্থাপিত হবে।",
        ...
        doneSummary: "সম্পন্ন: {{groups}}টি ফোল্ডার তৈরি হয়েছে, {{sources}}টি সোর্স শ্রেণীবদ্ধ হয়েছে, {{unclassified}}টি অশ্রেণীবদ্ধ",
  ...
  settings: {
    ...
    appearance: "চেহারা",
    appearanceDesc: "Open Notebook-এর চেহারা বেছে নিন। সাথে সাথে প্রযোজ্য হয়।",
    skin: "ইন্টারফেস স্কিন",
    skinQuietGreen: "Quiet Green",
    skinQuietGreenDesc: "ডিফল্ট চেহারা — উষ্ণ কাগজের রঙ ও সবুজ আভা।",
    skinClassic: "ক্লাসিক",
    skinClassicDesc: "আগের সংস্করণের সাদা-নীল ক্লাসিক ইন্টারফেস।",
  },
  advanced: {
    title: "উন্নত টুলস",
  ...
  dataManagement: {
    ...
    import: {
      ...
      importAnother: "অন্য একটি প্যাকেজ আমদানি করুন",
    },
    errors: {
