...
export const zhTW = {
  ...
  apiErrors: {
    ...
    groupDepthExceeded: "資料夾層級已達上限（最多 5 層）",
  ...
  sources: {
    ...
    grouping: {
      ...
      newSubgroup: "新增子資料夾",
      newGroupTitle: "新增資料夾",
      renameGroupTitle: "重新命名資料夾",
      groupNamePlaceholder: "資料夾名稱",
      ...
      rootOption: "Root",
      noGroups: "還沒有資料夾",
      deleteGroupTitle: "刪除資料夾「{{name}}」？",
      deleteGroupDesc: "資料夾內來源將移出資料夾。",
      deleteGroupWithSources: "同時刪除資料夾內全部來源",
      deleteGroupWithSourcesWarn: "此資料夾及其子資料夾內的全部來源將被永久刪除，且無法復原。",
      cascadeConfirmTitle: "Delete sources permanently?",
      cascadeConfirmDesc: "此資料夾及其子資料夾內的來源將連同檔案與洞察一併刪除，此操作無法復原。",
      ...
      copyToGroup: "複製到資料夾",
      ungroupAction: "移出資料夾",
      moveToGroupTitle: "將來源移動到資料夾",
      copyToGroupTitle: "將來源複製到資料夾",
      copyHere: "Copy here",
      moveSuccess: "Moved {{count}} source(s)",
      copySuccess: "Copied {{count}} source(s)",
      ungroupSuccess: "已將 {{count}} 個來源移出資料夾",
      bulkPartial: "{{success}} succeeded, {{failed}} failed",
      operationFailed: "The operation failed. Please try again.",
      rowActions: "「{{title}}」的操作",
      renameSource: "重新命名",
      renameSourceTitle: "重新命名來源",
      copyTo: "複製到…",
      copyCreatedToast: "已建立「{{title}}」的副本",
      batchRename: "重新命名",
      batchRenameTitle: "批次重新命名",
      batchRenameDesc: "為已選 {{count}} 個來源設定重新命名規則",
      prefixLabel: "前綴",
      suffixLabel: "後綴",
      findLabel: "尋找",
      replaceLabel: "取代為",
      previewLabel: "預覽：{{changed}}/{{count}} 項將變更",
      previewUnchanged: "無變化",
      noChanges: "目前規則不會變更任何來源",
      applyRename: "套用重新命名",
      renameSuccess: "已重新命名 {{count}} 個來源",
      renameSlowHint: "項目較多時逐條寫入需要一些時間",
      batchDelete: "刪除",
      batchDeleteConfirmTitle: "刪除 {{count}} 個來源？",
      batchDeleteConfirmDesc: "來源將連同檔案、洞察與資料夾歸屬一併刪除，無法復原",
      batchDeleteSuccess: "已刪除 {{count}} 個來源",
      dragInvalidTarget: "無法移動到自身或其子資料夾",
      saveToFolder: "儲存到資料夾（可選）",
      noFolderOption: "不放入任何資料夾",
      targetFolderLabel: "目標資料夾",
      selectFolder: "選擇資料夾",
      stepNotebooksAndFoldersTitle: "筆記本與資料夾",
      stepNotebooksAndFoldersDesc: "關聯至筆記本並歸類到資料夾",
      aiOverwriteHint: "AI 重新分類會覆蓋此資料夾集中的手動歸檔",
      folderAssignFailed: "{{count}} 個來源已建立，但未能放入資料夾",
      breadcrumbAria: "目前位置",
      ...
      groupCreatedInFolder: "已在「{{parent}}」內建立資料夾「{{name}}」",
      familyMine: "My folders",
      defaultCustomViewName: "我的資料夾",
      ...
      classify: {
        ...
        confirmDescription: "AI 將重建「{{name}}」中的全部資料夾，這套資料夾集現有的資料夾及手動歸檔都會被覆蓋。",
        ...
        doneSummary: "完成：建立 {{groups}} 個資料夾，已分類 {{sources}} 個來源，{{unclassified}} 個未分類",
  ...
  settings: {
    ...
    loadFailed: "載入設定失敗",
    appearance: "外觀",
    appearanceDesc: "選擇 Open Notebook 的介面風格，立即生效。",
    skin: "介面主題",
    skinQuietGreen: "Quiet Green",
    skinQuietGreenDesc: "預設外觀——溫暖的紙感色調與綠色點綴。",
    skinClassic: "經典版",
    skinClassicDesc: "早期版本的白底藍主色經典介面。",
  },
  advanced: {
    title: "進階工具",
