...
export const esES = {
  ...
  sources: {
    ...
    grouping: {
      ...
      newGroup: "Nueva carpeta",
      newSubgroup: "Nueva subcarpeta",
      newGroupTitle: "Nueva carpeta",
      renameGroupTitle: "Renombrar carpeta",
      groupNamePlaceholder: "Nombre de la carpeta",
      groupOptions: "Options for {{name}}",
      moveTo: "Move to...",
      moveHere: "Move here",
      moveGroupTitle: "Move \"{{name}}\"",
      rootOption: "Root",
      noGroups: "Aún no hay carpetas",
      deleteGroupTitle: "¿Eliminar la carpeta \"{{name}}\"?",
      deleteGroupDesc: "Las fuentes que contiene se sacarán de la carpeta.",
      deleteGroupWithSources: "Eliminar también todas las fuentes de esta carpeta",
      deleteGroupWithSourcesWarn: "Todas las fuentes de esta carpeta y sus subcarpetas se eliminarán permanentemente. Esto no se puede deshacer.",
      cascadeConfirmTitle: "Delete sources permanently?",
      cascadeConfirmDesc: "Las fuentes de esta carpeta y sus subcarpetas se eliminarán junto con sus archivos e insights. Esto no se puede deshacer.",
      ...
      moveToGroup: "Mover a carpeta",
      copyToGroup: "Copiar a carpeta",
      ungroupAction: "Sacar de la carpeta",
      moveToGroupTitle: "Mover fuentes a carpeta",
      copyToGroupTitle: "Copiar fuentes a carpeta",
      copyHere: "Copy here",
      moveSuccess: "Moved {{count}} source(s)",
      copySuccess: "Copied {{count}} source(s)",
      ungroupSuccess: "{{count}} fuente(s) sacadas de sus carpetas",
      bulkPartial: "{{success}} succeeded, {{failed}} failed",
      operationFailed: "The operation failed. Please try again.",
      rowActions: "Opciones de {{title}}",
      renameSource: "Renombrar",
      renameSourceTitle: "Renombrar fuente",
      copyTo: "Copiar a...",
      copyCreatedToast: "Copia de \"{{title}}\" creada",
      batchRename: "Renombrar",
      batchRenameTitle: "Cambio de nombre por lotes",
      batchRenameDesc: "Definir reglas de renombrado para {{count}} fuente(s) seleccionada(s)",
      prefixLabel: "Prefijo",
      suffixLabel: "Sufijo",
      findLabel: "Buscar",
      replaceLabel: "Reemplazar por",
      previewLabel: "Vista previa: {{changed}} de {{count}} cambiarán",
      previewUnchanged: "sin cambios",
      noChanges: "Ninguna fuente cambiaría con estas reglas",
      applyRename: "Aplicar cambio de nombre",
      renameSuccess: "{{count}} fuente(s) renombradas",
      renameSlowHint: "Los elementos se aplican uno a uno; puede tardar un poco",
      batchDelete: "Eliminar",
      batchDeleteConfirmTitle: "¿Eliminar {{count}} fuente(s)?",
      batchDeleteConfirmDesc: "Las fuentes se eliminarán junto con sus archivos, insights y asignación a carpetas. Esto no se puede deshacer.",
      batchDeleteSuccess: "{{count}} fuente(s) eliminadas",
      dragInvalidTarget: "No se puede mover a sí misma ni a una subcarpeta",
      saveToFolder: "Guardar en carpeta (opcional)",
      noFolderOption: "No poner en ninguna carpeta",
      targetFolderLabel: "Carpeta de destino",
      selectFolder: "Seleccionar carpeta",
      stepNotebooksAndFoldersTitle: "Cuadernos y carpetas",
      stepNotebooksAndFoldersDesc: "Asociar a cuadernos y organizar en una carpeta",
      aiOverwriteHint: "Volver a ejecutar la clasificación con IA sobrescribirá la organización manual en esta vista",
      folderAssignFailed: "{{count}} fuente(s) creadas pero no se pudieron archivar en la carpeta",
      ...
      classify: {
        ...
        confirmDescription: "La IA reconstruirá todas las carpetas de \"{{name}}\". Las carpetas existentes y cualquier reorganización manual en esta vista se reemplazarán.",
        ...
        doneSummary: "Hecho: {{groups}} carpeta(s) creadas, {{sources}} fuentes clasificadas, {{unclassified}} sin clasificar",
  ...
  settings: {
    ...
    appearanceDesc: "Elige el aspecto de Open Notebook. Se aplica de inmediato.",
    skin: "Apariencia de la interfaz",
    skinQuietGreen: "Quiet Green",
    skinQuietGreenDesc: "El aspecto predeterminado: tonos cálidos de papel y acentos verdes.",
    skinClassic: "Clásico",
    skinClassicDesc: "La interfaz clásica en blanco y azul de versiones anteriores.",
  },
  advanced: {
  ...
  dataManagement: {
    ...
    import: {
      ...
      importAnother: "Importar otro paquete",
    },
    errors: {
