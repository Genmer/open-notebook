...
export const frFR = {
  ...
  sources: {
    ...
    grouping: {
      ...
      all: "All",
      ungrouped: "Hors dossier",
      newGroup: "Nouveau dossier",
      newSubgroup: "Nouveau sous-dossier",
      newGroupTitle: "Nouveau dossier",
      renameGroupTitle: "Renommer le dossier",
      groupNamePlaceholder: "Nom du dossier",
      groupOptions: "Options for {{name}}",
      moveTo: "Move to...",
      moveHere: "Move here",
      moveGroupTitle: "Move \"{{name}}\"",
      rootOption: "Root",
      noGroups: "Aucun dossier pour l'instant",
      deleteGroupTitle: "Supprimer le dossier \"{{name}}\" ?",
      deleteGroupDesc: "Les sources qu'il contient seront retirées du dossier.",
      deleteGroupWithSources: "Supprimer aussi toutes les sources de ce dossier",
      deleteGroupWithSourcesWarn: "Toutes les sources de ce dossier et de ses sous-dossiers seront supprimées définitivement. Cette action est irréversible.",
      cascadeConfirmTitle: "Delete sources permanently?",
      cascadeConfirmDesc: "Les sources de ce dossier et de ses sous-dossiers seront supprimées avec leurs fichiers et leurs insights. Cette action est irréversible.",
      ...
      moveToGroup: "Déplacer vers un dossier",
      copyToGroup: "Copier vers un dossier",
      ungroupAction: "Retirer du dossier",
      moveToGroupTitle: "Déplacer des sources vers un dossier",
      copyToGroupTitle: "Copier des sources vers un dossier",
      copyHere: "Copy here",
      moveSuccess: "Moved {{count}} source(s)",
      copySuccess: "Copied {{count}} source(s)",
      ungroupSuccess: "{{count}} source(s) retirée(s) de leurs dossiers",
      bulkPartial: "{{success}} succeeded, {{failed}} failed",
      operationFailed: "The operation failed. Please try again.",
      rowActions: "Options de {{title}}",
      renameSource: "Renommer",
      renameSourceTitle: "Renommer la source",
      copyTo: "Copier vers...",
      copyCreatedToast: "Copie de \"{{title}}\" créée",
      batchRename: "Renommer",
      batchRenameTitle: "Renommage par lots",
      batchRenameDesc: "Définir des règles de renommage pour {{count}} source(s) sélectionnée(s)",
      prefixLabel: "Préfixe",
      suffixLabel: "Suffixe",
      findLabel: "Rechercher",
      replaceLabel: "Remplacer par",
      previewLabel: "Aperçu : {{changed}} sur {{count}} seront modifiées",
      previewUnchanged: "inchangé",
      noChanges: "Aucune source ne serait modifiée avec ces règles",
      applyRename: "Appliquer le renommage",
      renameSuccess: "{{count}} source(s) renommée(s)",
      renameSlowHint: "Les éléments sont appliqués un par un ; cela peut prendre un moment",
      batchDelete: "Supprimer",
      batchDeleteConfirmTitle: "Supprimer {{count}} source(s) ?",
      batchDeleteConfirmDesc: "Les sources seront supprimées avec leurs fichiers, leurs insights et leur classement en dossier. Cette action est irréversible.",
      batchDeleteSuccess: "{{count}} source(s) supprimée(s)",
      dragInvalidTarget: "Impossible de déplacer dans lui-même ou l'un de ses sous-dossiers",
      saveToFolder: "Enregistrer dans un dossier (facultatif)",
      noFolderOption: "Ne mettre dans aucun dossier",
      targetFolderLabel: "Dossier cible",
      selectFolder: "Sélectionner un dossier",
      stepNotebooksAndFoldersTitle: "Carnets et dossiers",
      stepNotebooksAndFoldersDesc: "Associer aux carnets et organiser dans un dossier",
      aiOverwriteHint: "Relancer la classification IA écrasera le classement manuel de cette vue",
      folderAssignFailed: "{{count}} source(s) créée(s) mais n'ont pas pu être classées dans le dossier",
      breadcrumbAria: "Emplacement actuel",
      ...
      classify: {
        ...
        confirmDescription: "L'IA reconstruira tous les dossiers de \"{{name}}\". Les dossiers existants et tout reclassement manuel dans cette vue seront remplacés.",
        ...
        doneSummary: "Terminé : {{groups}} dossier(s) créé(s), {{sources}} sources classées, {{unclassified}} non classées",
  ...
  settings: {
    ...
    appearanceDesc: "Choisissez l'apparence d'Open Notebook. Appliquée immédiatement.",
    skin: "Habillage de l'interface",
    skinQuietGreen: "Quiet Green",
    skinQuietGreenDesc: "L'apparence par défaut — tons papier chauds et accents verts.",
    skinClassic: "Classique",
    skinClassicDesc: "L'interface classique en blanc et bleu des versions précédentes.",
  },
  advanced: {
  ...
  dataManagement: {
    ...
    import: {
      ...
      importAnother: "Importer un autre paquet",
    },
    errors: {
