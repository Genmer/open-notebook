...
export const zhCN = {
  ...
  apiErrors: {
    ...
    groupDuplicateName: "同级已存在同名文件夹。它就在当前这套文件夹里，返回上级或查看弹窗中的同级列表即可看到。",
    groupDepthExceeded: "文件夹层级已达上限（最多 5 层）",
  ...
  sources: {
    ...
    embedding: "正在嵌入...",
    alreadyEmbedded: "已嵌入",
    embeddingInProgress: "嵌入中",
    embeddingStatusQueued: "嵌入已排队",
    embeddingStatusRunning: "正在嵌入",
    embeddingStatusCompleted: "已完成嵌入",
    embeddingWaitingWorker: "等待 worker 处理嵌入任务",
    embeddingProgressChunks: "已嵌入 {{embedded}}/{{total}} 块",
    embeddingCompletedChunks: "已嵌入 {{count}} 块",
    embeddingRetry: "重试嵌入",
    embeddingPartialTitle: "嵌入未完成",
    embeddingFailedTitle: "嵌入失败",
    embeddingIncomplete: "嵌入未完成",
    embeddingIncompleteHint: "点击前往详情页重新嵌入",
    downloadFile: "下载文件",
    ...
    processingStepExtraction: "提取内容",
    processingStepEmbedding: "生成向量嵌入",
    processingStepTransformation: "生成洞察",
    processingStepCompletion: "完成收尾",
    processingStatusPending: "等待中",
    processingStatusInProgress: "进行中",
    processingStatusDone: "已完成",
    processingStatusFailed: "失败",
    processingStatusSkipped: "已跳过",
    processingStatusUnknown: "未知",
    refreshContent: "刷新内容",
    deleteSource: "删除来源",
    retry: "重试",
    ...
    transformationTitleDenseSummary: "Dense Summary（稠密摘要）",
    transformationTitlePaperAnalysis: "Paper Analysis（论文分析）",
    transformationTitleReflectionQuestions: "Reflection Questions（反思问题）",
    ...
    grouping: {
      ...
      viewSelectLabel: "整理方式",
      groupSelectLabel: "文件夹",
      allViews: "全部来源",
      fileTypeTab: "文件类型",
      viewOptions: "文件夹集操作",
      addView: "新建一套文件夹",
      addViewTitle: "新建一套文件夹",
      renameViewTitle: "重命名文件夹集",
      viewNameDesc: "一套独立的文件夹树，跨笔记本共用；可建多套互不影响。",
      viewNamePlaceholder: "文件夹集名称",
      deleteViewTitle: "删除文件夹集「{{name}}」？",
      deleteViewDesc: "此文件夹集内的全部文件夹将被移除，来源本身不受影响。",
      all: "全部",
      ungrouped: "未放入文件夹",
      newGroup: "新建文件夹",
      newSubgroup: "新建子文件夹",
      newGroupTitle: "新建文件夹",
      renameGroupTitle: "重命名文件夹",
      groupNamePlaceholder: "文件夹名称",
      groupOptions: "「{{name}}」的操作",
      moveTo: "移动到…",
      moveHere: "移动到此处",
      moveGroupTitle: "移动「{{name}}」",
      rootOption: "根目录",
      noGroups: "还没有文件夹",
      deleteGroupTitle: "删除文件夹「{{name}}」？",
      deleteGroupDesc: "文件夹内来源将移出文件夹。",
      deleteGroupWithSources: "同时删除文件夹内全部来源",
      deleteGroupWithSourcesWarn: "该文件夹及其子文件夹内的全部来源将被永久删除，且无法恢复。",
      cascadeConfirmTitle: "确认永久删除来源？",
      cascadeConfirmDesc: "该文件夹及其子文件夹内的来源将连同文件与洞察一并删除，此操作无法撤销。",
      emptyGroup: "这里还没有来源。",
      selectAllLoaded: "全选已加载的来源",
      selectRow: "选中「{{title}}」",
      selectedCount: "已选 {{count}} 项",
      selectedPageHint: "（仅覆盖已加载的 {{loaded}} 条；如需全选请用表头复选框）",
      moveToGroup: "移动到文件夹",
      copyToGroup: "复制到文件夹",
      ungroupAction: "移出文件夹",
      moveToGroupTitle: "将来源移动到文件夹",
      copyToGroupTitle: "将来源复制到文件夹",
      copyHere: "复制到此处",
      moveSuccess: "已移动 {{count}} 个来源",
      copySuccess: "已复制 {{count}} 个来源",
      ungroupSuccess: "已将 {{count}} 个来源移出文件夹",
      bulkPartial: "{{success}} 个成功，{{failed}} 个失败",
      operationFailed: "操作失败，请重试。",
      rowActions: "「{{title}}」的操作",
      renameSource: "重命名",
      renameSourceTitle: "重命名来源",
      copyTo: "复制到…",
      copyCreatedToast: "已创建「{{title}}」的副本",
      batchRename: "重命名",
      batchRenameTitle: "批量重命名",
      batchRenameDesc: "为已选 {{count}} 个来源设置重命名规则",
      prefixLabel: "前缀",
      suffixLabel: "后缀",
      findLabel: "查找",
      replaceLabel: "替换为",
      previewLabel: "预览：{{changed}}/{{count}} 项将更改",
      previewUnchanged: "无变化",
      noChanges: "当前规则不会更改任何来源",
      applyRename: "应用重命名",
      renameSuccess: "已重命名 {{count}} 个来源",
      renameSlowHint: "项数较多时逐条写入需要一些时间",
      batchDelete: "删除",
      batchDeleteConfirmTitle: "删除 {{count}} 个来源？",
      batchDeleteConfirmDesc: "来源将连同文件、洞察与文件夹归属一并删除，无法撤销",
      batchDeleteSuccess: "已删除 {{count}} 个来源",
      dragInvalidTarget: "无法移动到自身或其子文件夹",
      saveToFolder: "保存到文件夹（可选）",
      noFolderOption: "不放入任何文件夹",
      targetFolderLabel: "目标文件夹",
      selectFolder: "选择文件夹",
      stepNotebooksAndFoldersTitle: "笔记本与文件夹",
      stepNotebooksAndFoldersDesc: "关联到笔记本并归类到文件夹",
      aiOverwriteHint: "AI 重新分类会覆盖此文件夹集中的手动归档",
      folderAssignFailed: "{{count}} 个来源已创建，但未能放入文件夹",
      breadcrumbAria: "当前位置",
      moveToFolder: "移动到文件夹…",
      newFolder: "新建文件夹…",
      openSource: "打开",
      inlineCreateLabel: "创建",
      noGroupsCreateHint: "还没有文件夹，输入名称立即创建",
      groupCreatedToast: "已创建文件夹「{{name}}」",
      groupCreatedInView: "已在「{{view}}」中创建文件夹「{{name}}」",
      groupCreatedInFolder: "已在「{{parent}}」内创建文件夹「{{name}}」",
      moveTargetViewHint: "整理到：{{view}}",
      moveSuccessWithTarget: "已移动 {{count}} 个来源到「{{group}}」",
      familyMine: "我的文件夹",
      defaultCustomViewName: "我的文件夹",
      familyAi: "✨ AI 自动分类",
      familyFileType: "按文件类型",
      familyMineHint: "你手动建立和维护的文件夹，跨笔记本共用",
      familyAiHint: "AI 自动归类，重新分类会覆盖你在这套里的手动调整",
      familyFileTypeHint: "按文件格式自动分桶，只读",
      folderRailTitle: "文件夹",
      emptyFolderTitle: "「{{name}}」还没有来源",
      noSubfolders: "没有子文件夹",
      createInLabel: "将创建在：{{path}}",
      siblingFoldersLabel: "同级已有文件夹",
      duplicateNameInline: "同级已存在同名文件夹",
      classify: {
        button: "重新分类",
        confirmTitle: "运行 AI 分类？",
        confirmDescription: "AI 将重建「{{name}}」中的全部文件夹，这套文件夹集现有的文件夹及手动归档都会被覆盖。",
        confirmCta: "开始分类",
        startedToast: "AI 分类已开始",
        progressRunning: "分类中",
        stageClustering: "聚类中",
        stageLlm: "AI 分析中",
        stageAssigning: "写入中",
        doneSummary: "完成：创建 {{groups}} 个文件夹，已分类 {{sources}} 个来源，{{unclassified}} 个未分类",
        failed: "AI 分类失败",
      },
    },
  },
  ...
  settings: {
    ...
    chunkSize: "分块大小（token）",
    chunkSizeHelp: "文档嵌入前切分的每块最大 token 数。块越大上下文越完整，但单次嵌入调用成本越高。",
    chunkOverlap: "分块重叠（token）",
    chunkOverlapHelp: "相邻块共享的 token 数，保持跨块边界的上下文连贯。",
    minChunkSize: "最小块大小（token）",
    minChunkSizeHelp: "低于该 token 数的块会被丢弃，避免产生无效或空向量。",
    embeddingBatchSize: "嵌入批量大小",
    embeddingBatchSizeHelp: "每次嵌入 API 请求携带的文本条数。供应商拒绝大批量时调低（如百炼上限 10）。",
    chunkParamsChangedToast: "已有向量不会自动重算，如需要请在 Advanced 页面重建嵌入（Rebuild Embeddings）。",
    fileManagement: "文件管理",
    ...
    loadFailed: "加载设置失败",
    appearance: "外观",
    appearanceDesc: "选择 Open Notebook 的界面风格，立即生效。",
    skin: "界面皮肤",
    skinQuietGreen: "Quiet Green",
    skinQuietGreenDesc: "默认外观——温暖的纸感色调与绿色点缀。",
    skinClassic: "经典版",
    skinClassicDesc: "早期版本的白底蓝主色经典界面。",
  },
  advanced: {
    title: "高级工具",
    desc: "面向进阶用户的调试和实用工具",
  ...
  usage: {
    title: "Token 用量",
    description: "AI 调用的本地用量统计，数据只保存在你自己的数据库中。",
    privacyTitle: "隐私",
    privacyDesc: "用量数据只记录在本地数据库。关闭开关停止记录；点击清空可删除已记录的全部数据。",
    trackingEnabled: "记录 Token 用量",
    clear: "清空数据",
    clearConfirmTitle: "确认清空用量数据？",
    clearConfirmDesc: "将永久删除所有已记录的用量数据，此操作不可撤销。",
    clearedDesc: "已删除 {{count}} 条用量记录",
    clearFailed: "清空用量数据失败",
    totalCalls: "调用次数",
    ...
    calls: "调用",
    records: "最近记录",
    recordsDesc: "共 {{count}} 条记录，按时间倒序",
    created: "时间",
    callType: "类型",
    status: "状态",
    success: "成功",
    failure: "失败",
    estimatedHint: "Token 数为本地估算值",
    empty: "暂无用量记录",
    exportButton: "导出",
    exportCsv: "导出 CSV",
    exportJson: "导出 JSON",
    vsPrevPeriod: "较上一周期",
    noPrevPeriod: "无前期数据",
    estimatedNote: "其中约 {{tokens}} 为估算值",
    timeRange: "时间范围",
    filterByType: "按类型筛选",
    typeAll: "全部类型",
    typeChat: "对话",
    typeEmbedding: "向量化",
    typeTransformation: "转换",
    typeAsk: "问答",
    typeSourceChat: "来源对话",
    typePrompt: "提示词",
    loadMore: "加载更多",
    ...
    emptyTitle: "暂无用量记录",
    emptyDesc: "开始对话或处理来源后，这里会展示 token 用量。",
    filteredEmptyTitle: "所选范围内暂无用量记录",
    filteredEmptyDesc: "当前时间范围或调用类型下没有记录，可调整或重置筛选条件。",
    resetFilters: "重置筛选",
    errorTitle: "用量数据加载失败",
    errorDesc: "获取用量统计时出现问题。请确认 API 正在运行后重试。",
    retry: "重试",
    less: "少",
    more: "多",
    heatmapNoData: "该时段暂无用量记录",
    heatmapDesc: "固定近半年窗口，跟随类型筛选",
    trendAria: "近 {{days}} 天每日 token 趋势，按模型明细见表格",
    modelShareAria: "模型 token 占比，详见按模型统计表",
    dailyTotal: "当日合计",
  },
  app: {
    dataManagement: {
      title: "数据管理",
      description: "将库数据导出为可移植的打包文件，或从其他 Open Notebook 实例导入打包文件。",
    },
  },
  dataManagement: {
    export: {
      title: "导出",
      description: "将笔记本、来源、笔记、转换、文件夹与向量打包成一个可下载的 zip 文件。",
      idle: "暂无导出包。开始一次导出即可生成。",
      start: "导出数据",
      confirmTitle: "开始导出数据？",
      confirmDescription: "导出将在后台运行，覆盖笔记本、来源、笔记与向量。大型库可能需要较长时间。",
      startedToast: "导出已开始",
      stages: {
        collecting: "收集元数据",
        exporting_tables: "导出数据表",
        copying_files: "复制文件",
        exporting_embeddings: "导出向量",
        packaging: "打包",
      },
      downloading: "正在准备下载…",
      download: "下载导出包",
      deletePackage: "删除导出包",
      deleteConfirmTitle: "删除导出包？",
      deleteConfirmDesc: "将删除服务器上生成的 zip 文件，不影响库内数据。",
      deletedToast: "导出包已删除",
      summary: {
        packageSize: "包大小",
        tableCount: "记录数",
        counts: "{{table}}：{{count}}",
        filesSkipped: "{{count}} 个文件被跳过（磁盘缺失）",
      },
    },
    import: {
      title: "导入",
      description: "上传导出包以将其内容恢复到本实例。已有记录不会被覆盖，id 相同的记录将被跳过。",
      chooseFile: "选择打包文件",
      upload: "导入打包文件",
      uploading: "上传中…",
      limitHint: "上传上限：每个包 100 MB",
      confirmTitle: "导入此打包文件？",
      confirmDescription: "导入会向库中写入数据。已存在的记录（id 相同）会被跳过，不会被覆盖。",
      startedToast: "导入已开始",
      stages: {
        validating: "校验打包文件",
        precheck: "预检查",
      ...
      importAnother: "导入另一个包",
    },
    errors: {
      concurrent: "已有导出/导入任务在排队或运行中，请等待其完成。",
      uploadTooLarge: "打包文件超过 100 MB 上传上限。",
      failed: "操作失败。",
    },
  },
