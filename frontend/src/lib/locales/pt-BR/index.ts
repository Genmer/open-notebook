...
export const ptBR = {
  ...
  sources: {
    ...
    grouping: {
      ...
      all: "All",
      ungrouped: "Fora de pasta",
      newGroup: "Nova pasta",
      newSubgroup: "Nova subpasta",
      newGroupTitle: "Nova pasta",
      renameGroupTitle: "Renomear pasta",
      groupNamePlaceholder: "Nome da pasta",
      groupOptions: "Options for {{name}}",
      moveTo: "Move to...",
      moveHere: "Move here",
      moveGroupTitle: "Move \"{{name}}\"",
      rootOption: "Root",
      noGroups: "Nenhuma pasta ainda",
      deleteGroupTitle: "Excluir a pasta \"{{name}}\"?",
      deleteGroupDesc: "As fontes dentro dela serão removidas da pasta.",
      deleteGroupWithSources: "Excluir também todas as fontes desta pasta",
      deleteGroupWithSourcesWarn: "Todas as fontes desta pasta e de suas subpastas serão excluídas permanentemente. Isso não pode ser desfeito.",
      cascadeConfirmTitle: "Delete sources permanently?",
      cascadeConfirmDesc: "As fontes desta pasta e de suas subpastas serão excluídas junto com seus arquivos e insights. Isso não pode ser desfeito.",
      ...
      moveToGroup: "Mover para pasta",
      copyToGroup: "Copiar para pasta",
      ungroupAction: "Remover da pasta",
      moveToGroupTitle: "Mover fontes para pasta",
      copyToGroupTitle: "Copiar fontes para pasta",
      copyHere: "Copy here",
      moveSuccess: "Moved {{count}} source(s)",
      copySuccess: "Copied {{count}} source(s)",
      ungroupSuccess: "{{count}} fonte(s) removida(s) de suas pastas",
      bulkPartial: "{{success}} succeeded, {{failed}} failed",
      operationFailed: "The operation failed. Please try again.",
      rowActions: "Opções de {{title}}",
      renameSource: "Renomear",
      renameSourceTitle: "Renomear fonte",
      copyTo: "Copiar para...",
      copyCreatedToast: "Criada uma cópia de \"{{title}}\"",
      batchRename: "Renomear",
      batchRenameTitle: "Renomear em lote",
      batchRenameDesc: "Definir regras de renomeação para {{count}} fonte(s) selecionada(s)",
      prefixLabel: "Prefixo",
      suffixLabel: "Sufixo",
      findLabel: "Localizar",
      replaceLabel: "Substituir por",
      previewLabel: "Pré-visualização: {{changed}} de {{count}} serão alteradas",
      previewUnchanged: "sem alteração",
      noChanges: "Nenhuma fonte seria alterada com estas regras",
      applyRename: "Aplicar renomeação",
      renameSuccess: "{{count}} fonte(s) renomeada(s)",
      renameSlowHint: "Os itens são aplicados um a um; isso pode levar um momento",
      batchDelete: "Excluir",
      batchDeleteConfirmTitle: "Excluir {{count}} fonte(s)?",
      batchDeleteConfirmDesc: "As fontes serão excluídas com seus arquivos, insights e atribuições de pasta. Isso não pode ser desfeito.",
      batchDeleteSuccess: "{{count}} fonte(s) excluída(s)",
      dragInvalidTarget: "Não é possível mover para dentro de si mesma ou de uma subpasta",
      saveToFolder: "Salvar em pasta (opcional)",
      noFolderOption: "Não colocar em nenhuma pasta",
      targetFolderLabel: "Pasta de destino",
      selectFolder: "Selecionar pasta",
      stepNotebooksAndFoldersTitle: "Cadernos e pastas",
      stepNotebooksAndFoldersDesc: "Vincular a cadernos e organizar em uma pasta",
      aiOverwriteHint: "Executar novamente a classificação por IA substituirá a organização manual desta visualização",
      folderAssignFailed: "{{count}} fonte(s) criada(s), mas não foi possível colocá-las na pasta",
      breadcrumbAria: "Local atual",
      ...
      classify: {
        ...
        confirmDescription: "A IA reconstruirá todas as pastas de \"{{name}}\". As pastas existentes e qualquer reorganização manual nesta visualização serão substituídas.",
        ...
        doneSummary: "Concluído: {{groups}} pasta(s) criada(s), {{sources}} fontes classificadas, {{unclassified}} não classificadas",
  ...
  settings: {
    ...
    appearanceDesc: "Escolha a aparência do Open Notebook. Aplicada imediatamente.",
    skin: "Skin da interface",
    skinQuietGreen: "Quiet Green",
    skinQuietGreenDesc: "A aparência padrão — tons quentes de papel e acentos verdes.",
    skinClassic: "Clássico",
    skinClassicDesc: "A interface clássica em branco e azul das versões anteriores.",
  },
  advanced: {
  ...
  dataManagement: {
    ...
    import: {
      ...
      importAnother: "Importar outro pacote",
    },
    errors: {
