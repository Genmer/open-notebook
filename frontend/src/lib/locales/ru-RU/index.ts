...
export const ruRU = {
  ...
  sources: {
    ...
    grouping: {
      ...
      all: "All",
      ungrouped: "Не в папке",
      newGroup: "Новая папка",
      newSubgroup: "Новая подпапка",
      newGroupTitle: "Новая папка",
      renameGroupTitle: "Переименовать папку",
      groupNamePlaceholder: "Название папки",
      groupOptions: "Options for {{name}}",
      moveTo: "Move to...",
      moveHere: "Move here",
      moveGroupTitle: "Move \"{{name}}\"",
      rootOption: "Root",
      noGroups: "Папок пока нет",
      deleteGroupTitle: "Удалить папку \"{{name}}\"?",
      deleteGroupDesc: "Источники внутри будут убраны из папки.",
      deleteGroupWithSources: "Также удалить все источники в этой папке",
      deleteGroupWithSourcesWarn: "Все источники в этой папке и её подпапках будут удалены безвозвратно. Это действие нельзя отменить.",
      cascadeConfirmTitle: "Delete sources permanently?",
      cascadeConfirmDesc: "Источники в этой папке и её подпапках будут удалены вместе с файлами и инсайтами. Это действие нельзя отменить.",
      ...
      moveToGroup: "Переместить в папку",
      copyToGroup: "Копировать в папку",
      ungroupAction: "Убрать из папки",
      moveToGroupTitle: "Переместить источники в папку",
      copyToGroupTitle: "Копировать источники в папку",
      copyHere: "Copy here",
      moveSuccess: "Moved {{count}} source(s)",
      copySuccess: "Copied {{count}} source(s)",
      ungroupSuccess: "{{count}} источник(ов) убран(ы) из папок",
      bulkPartial: "{{success}} succeeded, {{failed}} failed",
      operationFailed: "The operation failed. Please try again.",
      rowActions: "Действия с {{title}}",
      renameSource: "Переименовать",
      renameSourceTitle: "Переименовать источник",
      copyTo: "Копировать в...",
      copyCreatedToast: "Создана копия \"{{title}}\"",
      batchRename: "Переименовать",
      batchRenameTitle: "Массовое переименование",
      batchRenameDesc: "Задать правила переименования для {{count}} выбранных источников",
      prefixLabel: "Префикс",
      suffixLabel: "Суффикс",
      findLabel: "Найти",
      replaceLabel: "Заменить на",
      previewLabel: "Предпросмотр: изменятся {{changed}} из {{count}}",
      previewUnchanged: "без изменений",
      noChanges: "По этим правилам не изменится ни один источник",
      applyRename: "Применить переименование",
      renameSuccess: "Переименовано источников: {{count}}",
      renameSlowHint: "Записи применяются по одной; это может занять некоторое время",
      batchDelete: "Удалить",
      batchDeleteConfirmTitle: "Удалить источников: {{count}}?",
      batchDeleteConfirmDesc: "Источники будут удалены вместе с файлами, инсайтами и привязкой к папкам. Это действие нельзя отменить.",
      batchDeleteSuccess: "Удалено источников: {{count}}",
      dragInvalidTarget: "Нельзя переместить папку в саму себя или её подпапку",
      saveToFolder: "Сохранить в папку (необязательно)",
      noFolderOption: "Не помещать в папку",
      targetFolderLabel: "Целевая папка",
      selectFolder: "Выбрать папку",
      stepNotebooksAndFoldersTitle: "Блокноты и папки",
      stepNotebooksAndFoldersDesc: "Привязать к блокнотам и упорядочить по папкам",
      aiOverwriteHint: "Повторный запуск классификации ИИ перезапишет ручную раскладку в этом представлении",
      folderAssignFailed: "{{count}} источник(ов) создано, но поместить в папку не удалось",
      breadcrumbAria: "Текущее расположение",
      ...
      classify: {
        ...
        confirmDescription: "ИИ перестроит все папки в \"{{name}}\". Существующие папки и ручная раскладка в этом представлении будут заменены.",
        ...
        doneSummary: "Готово: создано папок — {{groups}}, классифицировано источников — {{sources}}, не классифицировано — {{unclassified}}",
  ...
  settings: {
    ...
    appearanceDesc: "Выберите внешний вид Open Notebook. Применяется сразу.",
    skin: "Оформление интерфейса",
    skinQuietGreen: "Quiet Green",
    skinQuietGreenDesc: "Вид по умолчанию — тёплые бумажные тона и зелёные акценты.",
    skinClassic: "Классическое",
    skinClassicDesc: "Классический бело-синий интерфейс из прежних версий.",
  },
  advanced: {
  ...
  dataManagement: {
    ...
    import: {
      ...
      importAnother: "Импортировать другой пакет",
    },
    errors: {
